...
public final class Fantasy {
    ...
    private final net.bennyboops.modid.world.RuntimeWorldManager worldManager;
    ...
    private Fantasy(MinecraftServer server) {
        ...
        this.worldManager = new net.bennyboops.modid.world.RuntimeWorldManager(server);
    }
     ...
     * <p>
     * The created world is returned asynchronously through a {@link net.bennyboops.modid.world.RuntimeWorldHandle}.
     * This handle can be used to acquire the {@link ServerWorld} object through {@link net.bennyboops.modid.world.RuntimeWorldHandle#asWorld()},
     * as well as to delete the world through {@link net.bennyboops.modid.world.RuntimeWorldHandle#delete()}.
     *
     * @param config the config with which to construct this temporary world
     * @return a future providing the created world
     */
    public net.bennyboops.modid.world.RuntimeWorldHandle openTemporaryWorld(RuntimeWorldConfig config) {
        net.bennyboops.modid.world.RuntimeWorld world = this.addTemporaryWorld(config);
        return new net.bennyboops.modid.world.RuntimeWorldHandle(this, world);
    }
     ...
     * @return a future providing the created world
     */
    public net.bennyboops.modid.world.RuntimeWorldHandle getOrOpenPersistentWorld(Identifier key, RuntimeWorldConfig config) {
    ...
    private net.bennyboops.modid.world.RuntimeWorld addPersistentWorld(Identifier key, RuntimeWorldConfig config) {
        RegistryKey<World> worldKey = RegistryKey.of(RegistryKeys.WORLD, key);
        return this.worldManager.add(worldKey, config, net.bennyboops.modid.world.RuntimeWorld.Style.PERSISTENT);
    }

    private net.bennyboops.modid.world.RuntimeWorld addTemporaryWorld(RuntimeWorldConfig config) {
        ...
        return this.worldManager.add(worldKey, config, net.bennyboops.modid.world.RuntimeWorld.Style.TEMPORARY);
    }
    ...
    private void onServerStopping() {
        List<net.bennyboops.modid.world.RuntimeWorld> temporaryWorlds = this.collectTemporaryWorlds();
        for (net.bennyboops.modid.world.RuntimeWorld temporary : temporaryWorlds) {
            this.kickPlayers(temporary);
            this.worldManager.delete(temporary);
        }
    }

    private List<net.bennyboops.modid.world.RuntimeWorld> collectTemporaryWorlds() {
        List<net.bennyboops.modid.world.RuntimeWorld> temporaryWorlds = new ArrayList<>();
        for (ServerWorld world : this.server.getWorlds()) {
            if (world instanceof net.bennyboops.modid.world.RuntimeWorld) {
                net.bennyboops.modid.world.RuntimeWorld runtimeWorld = (net.bennyboops.modid.world.RuntimeWorld) world;
