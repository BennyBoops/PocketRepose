 ...
 *
 * @see net.bennyboops.modid.world.Fantasy
 */
public final class RuntimeWorldConfig {
    ...
    private net.bennyboops.modid.world.RuntimeWorld.Constructor worldConstructor = net.bennyboops.modid.world.RuntimeWorld::new;
    ...
    public RuntimeWorldConfig setWorldConstructor(net.bennyboops.modid.world.RuntimeWorld.Constructor constructor) {
