...
public class SuitcaseRegistryState extends PersistentState {
    ...
    public static SuitcaseRegistryState createFromNbt(NbtCompound nbt) {
        ...
        if (nbt.contains("SuitcaseRegistry")) {
            NbtList keystonesList = nbt.getList("SuitcaseRegistry", 10); // 10 is the tag type for compound
    ...
    public static void registerEvents() {
        // Initialize the registry on server start by loading from persistent state
